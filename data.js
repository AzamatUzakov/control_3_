...
for (let i of data) {
    ...
    // let button_flex_two = document.createElement('button')
    // let button_flex_three = document.createElement('button')
    ...
    //  block_img_mac.classList.add('')
    //    block_img_mac_photo.classList.add('imageee')
    block_img_mac_h1.classList.add('h1')
    block_img_mac_p.classList.add('p')
    hr.classList.add('hr')
    //  button_flex.classList.add('')
    //button_flex_three.classList.add('three')
    //  button_flex_two.classList.add('two')
    ...
    //  block_five_img.classList.add('')
    block_five_p.classList.add('p')

    block_six.classList.add('s')
    //  block_six_img.classList.add('')
    ...
    for (let b of i.colors) {
        ...
        block_eyt.append(block_eyt_img, block_eyt_p)
